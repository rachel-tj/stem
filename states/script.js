...
states[getHashCode('arizona')] = [109, 182, 227, false];
...
states[getHashCode('connecticut')] = [237, 207, 57, false];
states[getHashCode('delaware')] = [232, 46, 90, false];
...
states[getHashCode('maryland')] = [185, 240, 65];
states[getHashCode('massachusetts')] = [87, 123, 242];
...
states[getHashCode('vermont')] = [68, 235, 68];
...
states[getHashCode('wisconsin')] = [230, 135, 25];
